...
Leucine is the first of the residues of diminished frequency. It is nonpolar. It, and, skipping a frequency, methionine, isoleucine, and proline, may be disfavored from forming the few nonpolar interactions that do occur. Why is not clear - other small, nonpolar residues, and other lengthy nonpolar residues appear in the pocket in greater frequency.  do to their small size and weak nonpolarity (proline) or do to their steric hindrance Then serine, (polar), methionine (nonpolar), isoleucine(nonpolar), proline (nonpolar), histidine (polar), tryptophan (nonpolar), tyrosine (polar) and glutamate (polar). **ok, here I could discuss as I did with heme-b every residue, but I feel like here it's unreasonable... maybe just say no clear trend. Or for individual residues say why they're probs disfavored idk.** 
then tyr!! interesting it's so so low v. the other pockets

finally, glutamine way, way down. It's polar, but negatively chaged; but asp is @ median ish wtf??
