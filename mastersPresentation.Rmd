...
1. Introduces bias for residues on the fringes, but still orders residues by their respective distances and reduces noise from distant AA. **za->zr**
...
.left-column[
- THR overlooked in thesis text; but also polar
- TYR, HIS, ARGinine
- ARG salt bridges
- propionate groups
- HIS coordinates Fe
...
.left-column[
- GLY
- structural, so little = more rigid/less spacing?
]
...
.left[
last aa freq dataset here we go
]
...
- LOTS of polar
- ARG (e+)
- salt bridges and interactions w carboxyl/propionates
]
