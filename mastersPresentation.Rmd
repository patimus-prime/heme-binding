...
The name of all proteins used in the study and their source organism are provided.
...
1. Select ALL atoms within **residues with at least one atom within 7A of heme**
...
1. For distance used to filter: assign mean distance to each residue: Average distance of all atoms within each residue is the assigned distance per residue
...
1. Big ass study with many hemes and high throughput

1. we examined multiple factors that could affect binding

1. we find that I'm tired as fuck and going to bed. But everryyything is ready.

1. You can just reorganize words tomorrow, not so much work. talk to yourself and to nat later
