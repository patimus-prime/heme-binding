def angle_aa_ligand_plane(activeLigand,activeSourcePath,activeResultPath,angstromDistance):
    ...
    for fn in file_names:
        ...
        rc("define axis number 999999999 :"+activeLigand)#HEM")
        ...
        for currentResidue in chimera.selection.currentResidues():
            ...
            if activeLigand in currentResidue:
                print "Oops! Ligand shouldn't be compared to itself, Do nothing."
        ...
        saveReplyLog((activeResultPath + "/%s") %(fn + ".dist.angle.txt"))
        rc(("copy png file " + activeResultPath + "/%s") %(fn+".dist.angle.image.png"))
