...
for fn in file_names:
    ...
    rc("sel sel za < 7") # select all atoms within 5A of Fe (also de-selects Fe)
    ...
    saveReplyLog((full_results_path + "/%s") %(fn + ".only.dist.txt"))
    rc(("copy png file " + full_results_path + "/%s") %(fn+".only.dist.image.png"))
